...
import { Produit, ProduitAlimentaire, ProduitChimique, ProduitFragile, ProduitIncassable, ProduitMateriel } from './Model/Produit.js';
...
function afficherCargaisons(cargaisons: Cargaison[]) {
    const productList = document.getElementById('product-list');'pr';
  ...
  document.getElementById('type-produit')?.addEventListener('change', (event) => {
    ...
    if (!toxiciteField) return;
    
    const typeProduit = (event.target as HTMLSelectElement).value;
  ...
  document.getElementById('form-add-cargaison')?.addEventListener('submit', (event) => {
    ...
    const toxiciteProduit = parseFloat((document.getElementById('toxicite-produit') as HTMLInputElement).value);
    ...
    (document.getElementById('libelle-produit') as HTMLSelectElement).value = '';
    (document.getElementById('poids-produit') as HTMLSelectElement).value = '';
    (document.getElementById('toxicite-produit') as HTMLSelectElement).value = '';
    (document.getElementById('type-cargaison') as HTMLSelectElement).value = '';
    (document.getElementById('type-produit') as HTMLSelectElement).value = '';
    (document.getElementById('toxicite-field') as HTMLSelectElement).classList.remove('hidden');
